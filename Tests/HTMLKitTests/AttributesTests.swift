...
final class AttributesTests: XCTestCase {
    ...
    struct Tag: ContentNode, GlobalElement, AllAttributes {
        ...
        func integrity(_ hashes: String...) -> AttributesTests.Tag {

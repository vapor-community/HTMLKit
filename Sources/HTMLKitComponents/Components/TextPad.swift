            ...
            Division {
                Details {
                    ...
                    UnorderedList {
                        ListItem {
                            ...
                            .accessibilityLabel(verbatim: "Format as bold")
                            Span {
                                "Bold"
                            }
                            .class("tooltip")
                        ...
                        ListItem {
                            ...
                            .accessibilityLabel(verbatim: "Format as italic")
                            Span {
                                "Italic"
                            }
                            .class("tooltip")
                        ...
                        ListItem {
                            ...
                            .accessibilityLabel(verbatim: "Format as strikethrough")
                            Span {
                                "Strikethrough"
                            }
                            .class("tooltip")
                        ...
                        ListItem {
                            ...
                            .accessibilityLabel(verbatim: "Format as link")
                            Span {
                                "Link"
                            }
                            .class("tooltip")
                        ...
                        ListItem {
                            ...
                            .accessibilityLabel(verbatim: "Format as code")
                            Span {
                                "Code"
                            }
                            .class("tooltip")
                ...
                Menu {
                    ListItem {
                        ...
                        .accessibilityLabel(verbatim: "Undo change")
                        Span {
                            "Undo"
                        }
                        .class("tooltip")
                    ...
                    ListItem {
                        ...
                        .accessibilityLabel(verbatim: "Redo change")
                        Span {
                            "Redo"
                        }
                        .class("tooltip")

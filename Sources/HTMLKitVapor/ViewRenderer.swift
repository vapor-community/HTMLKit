...
public class ViewRenderer {
    ...
    public init(eventLoop: EventLoop, localization: LocalizationConfiguration, environment: Environment) {
        
        self.eventLoop = eventLoop
        self.renderer = Renderer(localization: localization.localization, manager: environment.manager)
    }

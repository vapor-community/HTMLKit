...
//struct DateVariable<T: ContextualTemplate>: View {
//
//    enum Referance {
...
//    public func date(_ datePath: KeyPath<Context, Date>, dateStyle: DateFormatter.Style = .short, timeStyle: DateFormatter.Style = .short) -> View {
//        let formatter = DateFormatter()
...
//    /// - Returns: A `CompiledTemplate`
//    public func date(_ datePath: KeyPath<Context, Date>, formatter: DateFormatter) -> View {
...
//    /// - Returns: A `CompiledTemplate`
//    public func date(_ datePath: KeyPath<Context, Date>, format: String) -> View {
//        let formatter = DateFormatter()
